 ...
 * spécifiée. À l'expiration, le scheduler {@code PropertySchedulerJob} remet automatiquement
 * {@code boosted = false}. Un admin peut booster à nouveau en appelant le même endpoint.
 */
