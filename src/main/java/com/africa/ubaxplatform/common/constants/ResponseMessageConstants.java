...
public class ResponseMessageConstants {
  ...
  public static final String CONTRACT_CREATE_FAILURE_PROPERTY_CONFLICT =
      "CONTRACT_CREATE_FAILURE_PROPERTY_CONFLICT";
  public static final String CONTRACT_CREATE_FAILURE_TENANT_CONFLICT =
      "CONTRACT_CREATE_FAILURE_TENANT_CONFLICT";
  ...
  public static final String MANDATE_CREATE_SUCCESS = "MANDATE_CREATE_SUCCESS";
  public static final String MANDATE_GET_SUCCESS = "MANDATE_GET_SUCCESS";
  public static final String MANDATE_GET_LIST_SUCCESS = "MANDATE_GET_LIST_SUCCESS";
  public static final String MANDATE_SUBMIT_SUCCESS = "MANDATE_SUBMIT_SUCCESS";
  public static final String MANDATE_ACTIVATE_SUCCESS = "MANDATE_ACTIVATE_SUCCESS";
  public static final String MANDATE_TERMINATE_SUCCESS = "MANDATE_TERMINATE_SUCCESS";
  public static final String MANDATE_CANCEL_SUCCESS = "MANDATE_CANCEL_SUCCESS";
  public static final String MANDATE_NOT_FOUND = "MANDATE_NOT_FOUND";
  public static final String MANDATE_CONFLICT = "MANDATE_CONFLICT";
  public static final String MANDATE_INVALID_TRANSITION = "MANDATE_INVALID_TRANSITION";
  public static final String MANDATE_ACCESS_DENIED = "MANDATE_ACCESS_DENIED";
  public static final String BAILLEUR_AGENCY_BAILLEURS_SUCCESS =
      "BAILLEUR_AGENCY_BAILLEURS_SUCCESS";
  public static final String BAILLEUR_AGENCY_LINK_NOT_FOUND = "BAILLEUR_AGENCY_LINK_NOT_FOUND";
  ...
  public static final String VISIT_AVAILABILITY_CONFIGURE_SUCCESS =
      "VISIT_AVAILABILITY_CONFIGURE_SUCCESS";
  public static final String VISIT_AVAILABILITY_UPDATE_SUCCESS =
      "VISIT_AVAILABILITY_UPDATE_SUCCESS";
  public static final String VISIT_REQUEST_CREATE_SUCCESS = "VISIT_REQUEST_CREATE_SUCCESS";
  public static final String VISIT_REQUEST_GET_SUCCESS = "VISIT_REQUEST_GET_SUCCESS";
  public static final String VISIT_REQUEST_GET_LIST_SUCCESS = "VISIT_REQUEST_GET_LIST_SUCCESS";
  public static final String VISIT_REQUEST_CANCEL_SUCCESS = "VISIT_REQUEST_CANCEL_SUCCESS";
  public static final String VISIT_REQUEST_CONFIRM_SUCCESS = "VISIT_REQUEST_CONFIRM_SUCCESS";
  public static final String VISIT_REQUEST_REJECT_SUCCESS = "VISIT_REQUEST_REJECT_SUCCESS";
  public static final String VISIT_REQUEST_ASSIGN_SUCCESS = "VISIT_REQUEST_ASSIGN_SUCCESS";
  public static final String VISIT_REQUEST_NOT_FOUND = "VISIT_REQUEST_NOT_FOUND";
  public static final String VISIT_REQUEST_INVALID_TRANSITION = "VISIT_REQUEST_INVALID_TRANSITION";
  public static final String VISIT_AVAILABILITY_NOT_FOUND = "VISIT_AVAILABILITY_NOT_FOUND";
}
