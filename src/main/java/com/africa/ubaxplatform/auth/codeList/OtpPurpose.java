 ...
 *
 * <p><b>Durée de validité :</b> configurable via {@code otp.expiration-minutes} dans
 * {@code application.yml}. Par défaut : 5 minutes.
 *
...
public enum OtpPurpose {
   ...
   * appartient bien à l'utilisateur. Le compte reste en statut {@code phoneVerified = false}
   ...
   *
   * <p>Envoyé à la demande de l'utilisateur qui ne peut plus se connecter. La validation de ce
   * code autorise la saisie d'un nouveau mot de passe dans Keycloak via le flux de récupération
   * de compte.
   */
  PASSWORD_RESET
}
