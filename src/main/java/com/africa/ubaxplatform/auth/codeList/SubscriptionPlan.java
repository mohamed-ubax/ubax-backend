...
/**
 * Offre d'abonnement souscrite par une agence immobilière sur la plateforme UBAX. Détermine les
 * fonctionnalités accessibles (nombre d'annonces, outils avancés...).
 */
