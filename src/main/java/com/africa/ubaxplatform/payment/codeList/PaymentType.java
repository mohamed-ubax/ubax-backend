 ...
 *
 * <p>Chaque paiement est catégorisé selon sa nature afin de permettre un suivi comptable précis
 * et d'alimenter les tableaux de bord financiers (revenus locatifs, commissions perçues,
...
public enum PaymentType {
   ...
   * pour tout contrat en statut {@code ACTIVE}. Le montant correspond au loyer hors charges
   * défini dans le contrat. Le statut initial est {@code PENDING} jusqu'à encaissement.
   */
  RENT,
   ...
   *
   * <p>Montant garantissant les dégradations éventuelles en fin de bail. Généralement équivalent
   * à 1 ou 2 mois de loyer selon les termes du contrat. La caution est restituée (totalement ou
   ...
   * mandat signé avec le propriétaire. Ces revenus alimentent directement le dashboard financier
   * de l'agence.
   */
  COMMISSION,
   ...
   *
   * <p>Acompte, solde ou paiement unique dans le cadre d'un acte de vente. Le bien passe en
   * statut {@code SOLD} une fois la transaction finalisée. Déclenche la génération automatique
   * du document {@code RECEIPT} de type {@code SALE}.
   */
  SALE
}
