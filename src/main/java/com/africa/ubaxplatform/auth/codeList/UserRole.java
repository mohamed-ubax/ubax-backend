...
/**
 * Rôle fonctionnel d'un utilisateur sur la plateforme UBAX. Synchronisé depuis le realm Keycloak et
 * dupliqué en base pour les requêtes métier sans appel supplémentaire à Keycloak.
 */
