...
public record ExpenseCreateRequest(
    ...
    @NotNull
    @Schema(description = "Catégorie de la dépense", example = "MAINTENANCE")
    ExpenseCategory category,

    @NotNull
    @Schema(description = "Centre de coût", example = "PROPERTY_SPECIFIC")
    ...
    @NotNull
    @DecimalMin("0")
    @Schema(description = "Montant en XOF", example = "150000")
    BigDecimal amount,
    ...
    @NotNull
    @Schema(description = "Date de la dépense (ISO-8601)", example = "2025-10-12")
    LocalDate expenseDate,

    @Schema(description = "Nom du fournisseur ou prestataire", example = "SODECI")
    String provider,

    @Schema(description = "Référence facture ou bon de commande", example = "FAC-2025-1042")
    String invoiceReference,

    @Schema(description = "URL de la facture déjà uploadée dans MinIO")
